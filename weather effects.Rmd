...
Maximum fatalities occurred in 1995.
```{r,echo=TRUE,message=FALSE}
stormdata[stormdata$FATALITIES==max(stormdata$FATALITIES),c("year","EVTYPE.cor","FATALITIES")]
stormdata[stormdata$INJURIES==max(stormdata$INJURIES),c("year","EVTYPE.cor","INJURIES")]
```
